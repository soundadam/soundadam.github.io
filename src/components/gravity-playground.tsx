export function GravityPlayground() {
  return (
    <section className="mt-14 border-t border-[var(--color-border)] pt-8 sm:mt-16 sm:pt-10">
      <div className="relative mx-[-0.75rem] overflow-hidden rounded-[22px] border border-[var(--color-border)] bg-[var(--color-panel)] shadow-[0_18px_40px_rgba(24,20,16,0.05)] sm:mx-0 sm:rounded-[28px]">
